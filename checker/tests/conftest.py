...
def accounts() -> list[Account]:
    ...
    return [web3.eth.account.from_key(web3.keccak(os.urandom(32))) for i in range(10)]
...
@pytest.fixture(scope='function')
def default_compose_environment(web3_left: Web3, web3_right: Web3, accounts: list[Account]):
    return {
        # Owner 9 by default.
        'PRIVKEY': accounts[9]._private_key.hex(),
        'LEFT_RPCURL': web3_left.manager._provider.endpoint_uri,
        'RIGHT_RPCURL': web3_right.manager._provider.endpoint_uri,
        'LEFT_GASPRICE': '20000000000',
        'RIGHT_GASPRICE': '20000000000',
        'ORACLE_DATA': '/mnt/solution-data',
